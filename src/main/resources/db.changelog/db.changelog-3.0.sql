...
(
    id                   INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY, -- id паспорта
    ...
    client_id            INTEGER NOT NULL UNIQUE REFERENCES clients (id)   -- Уникальный id клиента, которому принадлежит паспорт
);