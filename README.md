...
Также на эту страницу можно перейти, нажав кнопку "Список клиентов" в навигационной панели на любой 
другой странице.  
...
указываются:
1. Тип операции (создание счёта, пополнение, списание, отправление перевода, получение перевода или закрытие 
счёта);
2. Дата и время выполнения операции;
...
5. Уникальный числовой идентификатор банковского счёта, которому принадлежит та или иная операция;
6. Числовой идентификатор банковского счёта отправителя перевода (при совершённом переводе. В остальных случаях 
   записывается null);
7. Числовой идентификатор банковского счёта получателя перевода (при совершённом переводе. В остальных случаях 
   записывается null).
